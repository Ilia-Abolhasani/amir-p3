...
c----------------------------------------------------------------------
      ...
      character as1gfile*12, as1hfile*12, path*80, a1header(50)*70,
...
c     Dangles
      ...
      character freein*10, enthpyin*10, path*80, rowheader(8,0:15)*96,
...
c--------------------------------------------------------------------
      ...
      character header(20)*70, gfile*8, path*80, outchar(100,3)*6,
...
c----------------------------------------------------------------------
      ...
      character gfile*12, hfile*12, text(12,0:10)*72, temp*72, path*80,
     .     outfile*12
...
c----------------------------------------------------------------------
      ...
      character mainheader(20)*50, temp*50, path*80,
...
c-----------------------------------------------------------------------
      ...
      character temp*20, gfile*9, hfile*9, path*80, mainheader(50)*96,
...
c-----------------------------------------------------------------
      subroutine tstack
      character tbleheader(0:6,0:20)*96, header(40)*96, gfile*11,
     .     hfile*11, path*80, outfile*11, outchar(4,4,16)*6, name*8,
